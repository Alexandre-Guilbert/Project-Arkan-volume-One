...
function lancerDe() {
    ...
    document.getElementById("choix-simple-13").style.display = "none";
    document.getElementById("choix-simple-14").style.display = "none";
    document.getElementById("choix-simple-15").style.display = "none";
    ...
    if (resultat <= 7) {
        document.getElementById("choix-simple-13").style.display = "block";
        document.getElementById("choix-mal").style.display = "block";
    } else if (resultat <= 14) {
        document.getElementById("choix-simple-14").style.display = "block";
        document.getElementById("choix-bon").style.display = "block";
    } else {
        document.getElementById("choix-simple-15").style.display = "block";
        document.getElementById("choix-mal").style.display = "block";
    }
