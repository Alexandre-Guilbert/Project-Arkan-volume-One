...
function lancerDe() {
    ...
    document.getElementById("choix-simple-7").style.display = "none";
    document.getElementById("choix-simple-8").style.display = "none";
    document.getElementById("choix-simple-9").style.display = "none";
    ...
    if (resultat <= 7) {
        document.getElementById("choix-simple-7").style.display = "block";
        document.getElementById("choix-bon").style.display = "block";
    } else if (resultat <= 14) {
        document.getElementById("choix-simple-8").style.display = "block";
        document.getElementById("choix-bon").style.display = "block";
    } else {
        document.getElementById("choix-simple-9").style.display = "block";
