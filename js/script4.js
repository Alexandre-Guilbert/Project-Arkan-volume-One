...
function lancerDe() {
    ...
    document.getElementById("choix-simple-10").style.display = "none";
    document.getElementById("choix-simple-11").style.display = "none";
    document.getElementById("choix-simple-12").style.display = "none";
    ...
    if (resultat <= 7) {
        document.getElementById("choix-simple-10").style.display = "block";
        document.getElementById("choix-bon").style.display = "block";
    } else if (resultat <= 14) {
        document.getElementById("choix-simple-11").style.display = "block";
        document.getElementById("choix-bon").style.display = "block";
    } else {
        document.getElementById("choix-simple-12").style.display = "block";
